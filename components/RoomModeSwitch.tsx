...
export default function RoomModeSwitch(props: RoomModeSwitchProps) {
  ...
  return (
    <>
      ...
      <button
        onClick={() => choose("lite")}
        className="fixed left-3 top-3 z-[60] flex items-center gap-1 rounded-lg border border-[#d8cfbb]/80 bg-[#fffdf8]/90 px-3 py-1.5 text-xs font-semibold text-[#574f43] shadow-[0_12px_26px_-20px_rgba(0,0,0,0.55)] backdrop-blur active:bg-[#efe9dd]"
